			...
			<div class="section1">
				<div class="main_banner">
					...
					<div class="banner_img">
						<img class="mainBanner1_txt" src="${pageContext.request.contextPath}/resources/pc/img/mainBanner1_txt.png">
						<img class="mainBanner_common" src="${pageContext.request.contextPath}/resources/pc/img/mainBanner_common.png">
						<img src="${pageContext.request.contextPath}/resources/pc/img/z.jpg">
					</div>
				</div>
			</div>
			<div class="section2">
